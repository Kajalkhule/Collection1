...
public class Test {
	 ...
	 public static void main(String[] args) {
            ...
            sl.add(new Student(101, "Srushti", "java", 250));
	        sl.add(new Student(102, "Sanskruti", "paython", 400));
	        sl.add(new Student(103, "Deepali", "aws", 450));
	        sl.add(new Student(104, "Amruta", "devoops", 320));
	        sl.add(new Student(105, "Vaishnavi", "data science", 150));
